...
import static com.example.adrian.kotlin_playground.common.FinalLinks.FORM_LINK;
...
public class DataViewerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> result = getResultsFromApi();
    }

    private void openAddDialog() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(FORM_LINK));
    ...
    private List<String> getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            AsyncTask<Void, Void, List<String>> result = new MakeRequestTask(mCredential).execute();
            try {
                return result.get();
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            DataViewerActivity.REQUEST_AUTHORIZATION);
                } else {
